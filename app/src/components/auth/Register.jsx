...
import { registerAction, redirect } from '../../core/store/actions/authActions/authActions'
...
class Register extends Component {
    ...
    onSubmitHandler(e) {
        ...
        let isValid = this.validations
            .isValidRegister(this.state.name, this.state.email, this.state.password, this.state.repeat)
